...
export const useTeamStore = defineStore('index', {
  state: () => ({
    ...
    team: [{
      player: {
        name: 'TinyRed',
        img: getImage('../assets/4.jpg'),
        bgimg: getImage('../assets/4.png'),
        bgbimg: getImage('../assets/4b.png'),
        summary: "YQYMONsAD钙奶",
      ...
      player: {
        name: 'HyBarain',
        img: getImage('../assets/2.jpg'),
        bgimg: getImage('../assets/2.png'),
        bgbimg: getImage('../assets/2b.png'),
        summary: "YQYMONs打野",
      ...
      player: {
        name: 'Nirvazure',
        img: getImage('../assets/3.jpg'),
        bgimg: getImage('../assets/3.png'),
        bgbimg: getImage('../assets/3b.png'),
        summary: "YQYMONs中单",
        heros: ["106", "107", "108", "109"],
        tags: ["团队大脑", "AP法王"]
      },
      ...
      player: {
        name: 'SandM影',
        img: getImage('../assets/1.jpg'),
        bgimg: getImage('../assets/1.png'),
        bgbimg: getImage('../assets/1b.png'),
        summary: "YQYMONs上单",
        heros: ["106", "107", "108", "109"],
        tags: ["上单霸主", "单打之王"]
      },
      ...
      player: {
        name: 'Uncle',
        img: getImage('../assets/5.jpg'),
        bgimg: getImage('../assets/5.png'),
        bgbimg: getImage('../assets/5b.png'),
        summary: "YQYMONs辅助",
        heros: ["106", "107", "108", "109"],
        tags: ["开团机器", "团队之盾"]
      },
  ...
  actions: {
    shuffler() {
      ...
      this.team.map(item => item.hero = getRandomInArray(this.heros))
